...
export class EngineInterface {
    ...
    async loadEngine() {
        ...
        this.shell.stdin.write('/Users/ghost/Documents/projects/offlinegpt/gpt4all/gpt4all/chat/gpt4all-lora-quantized-OSX-m1 -m /Users/ghost/Documents/projects/offlinegpt/gpt4all/gpt4all/chat/gpt4all-lora-quantized.bin\n');

        this.shell.stdout.on('data', (data) => {
            // console.log(`Shell data: ${data}`);
            this.updatesEmitter.emit('typing', data);
